...
hl.window_rule({match = {title = "^(Choose Adhan)(.*)$" },                   center = true}) 
hl.window_rule({match = {title = "^(Choose Adhan)(.*)$" },                   float = true})
hl.window_rule({match = {title = "^(Choose Adhan)(.*)$" },                   size = {"(monitor_w*.60)", "(monitor_h*.65)"}})
hl.window_rule({match = {title = "^(Choose Wireguard Config File)(.*)$" },   center = true})
hl.window_rule({match = {title = "^(Choose Wireguard Config File)(.*)$" },   float = true}) 
hl.window_rule({match = {title = "^(Choose Wireguard Config File)(.*)$" },   size ={"(monitor_w*.60)", "(monitor_h*.65)"}})
hl.window_rule({match = {title = "^(termfilechooser)$" },                    float = true})
hl.window_rule({match = {title = "^(termfilechooser)$" },                    size ={"(monitor_w*.90)", "(monitor_h*.85)"}})
...
hl.window_rule({match = {title = "^(illogical-impulse Settings)$" },         size={"(monitor_w*.90)", "(monitor_h*.85)"}})
...
hl.window_rule({match = {title = "^([Pp]icture[-\\s]?[Ii]n[-\\s]?[Pp]icture)(.*)$" }, move = {"(monitor_w*0.815)", "(monitor_h*0.06)"} })
hl.window_rule({match = {title = "^([Pp]icture[-\\s]?[Ii]n[-\\s]?[Pp]icture)(.*)$" }, size = {"(monitor_w*0.18)", "(monitor_h*0.18)"} })
hl.window_rule({match = {title = "^([Pp]icture[-\\s]?[Ii]n[-\\s]?[Pp]icture)(.*)$" }, float = true})
